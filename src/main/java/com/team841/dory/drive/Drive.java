...
import com.team841.dory.lib.AdvantageKit.LocalADStarAK;
...
public class Drive extends SubsystemBase {
    ...
    private static final double ROBOT_MASS_KG = 63.500;
    private static final double ROBOT_MOI = 3.624;
    ...
    public Drive(
        ...
        AutoBuilder.configure(
                ...
                new PPHolonomicDriveController(
                        new PIDConstants(41.418, 0, 1.344), new PIDConstants(34.459, 0, 2.5039)),
                PP_CONFIG,
    ...
    public void periodic() {
        ...
        // Update gyro alert
        gyroDisconnectedAlert.set(!gyroInputs.connected && RC.getMode() != RC.Mode.SIM);
    }
