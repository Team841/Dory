...
//    private static final Slot0Configs steerGains = new Slot0Configs().withKP(52.108).withKI(0).withKD(3.1803).withKS(0.22022).withKV(2.6525).withKA(0.066252).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
//    // When using closed-loop control, the drive motor uses the control
//    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
//    private static final Slot0Configs driveGains = new Slot0Configs().withKP(1.1357).withKI(0).withKD(0).withKS(0.14132).withKV(0.12513).withKA(0.017576);

    private static final Slot0Configs steerGains = new Slot0Configs().withKP(31.309).withKI(0).withKD(1.7315).withKS(0.13368).withKV(2.731).withKA(0.11717).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
//    // When using closed-loop control, the drive motor uses the control
//    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    ...
    public static final CANBus kCANBus = new CANBus("pi", "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.1396484375);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(0.3779296875);
