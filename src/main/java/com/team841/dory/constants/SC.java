...
public class SC {
    ...
    public static class Escalator {
        ...
        // with out coral
        public static Slot0Configs slot0Configs = new Slot0Configs().withKP(9.5).withKD(1.5).withKS(9.85).withKA(0.35).withKG(23.15).withGravityType(GravityTypeValue.Elevator_Static).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseVelocitySign);
        // with coral
        public static Slot1Configs slot1Configs = new Slot1Configs().withKP(10.5).withKD(1.4).withKS(9.85).withKA(0.19).withKG(25.75).withGravityType(GravityTypeValue.Elevator_Static).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseVelocitySign);
        ...
        private static final TalonFXConfiguration configs = new TalonFXConfiguration().withSlot0(slot0Configs).withSlot1(slot1Configs).withCurrentLimits(
                new CurrentLimitsConfigs().withStatorCurrentLimit(60).withStatorCurrentLimitEnable(true).withSupplyCurrentLimitEnable(true)).withFeedback(
                        new FeedbackConfigs().withFeedbackSensorSource(FeedbackSensorSourceValue.RotorSensor)).withMotionMagic(
                                new MotionMagicConfigs().withMotionMagicAcceleration(55).withMotionMagicCruiseVelocity(80).withMotionMagicJerk(800)).withMotorOutput(
