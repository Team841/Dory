...
//    public final Command intakeDown;
    ...
    public Control(Drivetrain drivetrain, Escalator escalator, Shooter shooter, FlapSystem flapSystem) {
        ...
        NamedCommands.registerCommand("FlapDown", new InstantCommand(() -> this.flapSystem.setFlapperDutyCycle(-0.40), flapSystem).withTimeout(1).finallyDo(flapSystem::stopFlapper));
